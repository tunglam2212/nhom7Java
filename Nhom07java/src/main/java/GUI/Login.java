...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                if(username.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Bạn chưa nhập tài khoản!", "Thông báo", JOptionPane.INFORMATION_MESSAGE); 
                } else if(password.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Mật khẩu không được để trống!", "Thông báo", JOptionPane.INFORMATION_MESSAGE); 
                } else {
                    boolean check = CBGVModify.checkUser(username, password);
                    if(check) {
                        Container ctn = new Container();
                        this.dispose();
                        ctn.setVisible(true);
                    } else {
                        JOptionPane.showMessageDialog(null, "Thông tin tài khoản hoặc mật khẩu không chính xác!", "Thông báo", JOptionPane.INFORMATION_MESSAGE); 
                    }
                }
